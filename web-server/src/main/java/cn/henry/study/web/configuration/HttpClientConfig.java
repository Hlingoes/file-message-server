...
/**
 * description: 在调用rest请求时,每次请求都需要和服务端建立连接,也就是三次握手,这是一个费时费力的工作,
...
public class HttpClientConfig {
    ...
    /**
     * 初始化RestTemplate,并加入spring的Bean工厂，由spring统一管理，重命名为httpClientTemplate
     */
    ...
    public ConnectionKeepAliveStrategy connectionKeepAliveStrategy() {
        return (response, context) -> {
            ...
            while (it.hasNext()) {
                ...
                LOGGER.info("HeaderElement:{}", JacksonUtils.object2Str(he));
