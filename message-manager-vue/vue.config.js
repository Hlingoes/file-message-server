// 原文链接：https://blog.csdn.net/u012302552/article/details/81742907
// vue.config.js 配置说明
    ...
    devServer: {
        ...
        proxy: {
            "/api": {
                ...
                changeOrigin: true,
                pathRewrite: {
                    // 这里理解成用'/api'代替target里面的地址,比如要调用'http://localhost:9000/web-server/test/hello1'，
                    // 直接写'/api/web-server/test/hello1'即可
                    "^/api": ""
                }
            },
            "/other": {
            ...
            "/socket": {
                ...
                pathRewrite: {
                    // 这里理解成用'/socket'代替target里面的地址,比如要调用'ws://localhost:9000/web-server/websocket'，
                    // 直接写'/socket/web-server/websocket'即可
                    "^/socket": "",
                },
