 ...
 * @since 3.0
 */
public enum HttpBasedStatusEnum {
    ...
    HttpBasedStatusEnum(int value, String reasonPhrase) {
        this.value = value;
     ...
     */
    public static HttpBasedStatusEnum valueOf(int statusCode) {
        HttpBasedStatusEnum status = resolve(statusCode);
        if (status == null) {
     ...
     * @since 5.0
     */
    public static HttpBasedStatusEnum resolve(int statusCode) {
        for (HttpBasedStatusEnum status : values()) {
    ...
    public enum Series {
        ...
        public static Series valueOf(HttpBasedStatusEnum status) {
